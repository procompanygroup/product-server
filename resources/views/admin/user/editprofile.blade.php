        ...
        <section class="content">
            ...
            <div class="card card-info">
                ...
                <div class="card-body  row">
                    <div class="col-lg-8">
                        <form class="form-horizontal" name="create_form" method="POST" action="{{route('user.updateprofile', $user->id)}}" 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="email"class="form-control" id="email"
                                        placeholder="* {{ __('general.email',[],'ar') }}" value="{{ $user->email }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control " name="name" id="name"
                                        placeholder="* {{ __('general.user_name',[],'ar') }}" value="{{ $user->name }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">                                     
                                    <button type="submit" type="submit" name="btn_update_user" id="btn_update"
                    ...
                    <div class="col-lg-4  sm-3  ">
                        <img alt="" id="imgshow" style="float: left !important;"
                            class="rounded img-thumbnail wd-100p float-sm-right  mg-t-10 mg-sm-t-0" src="{{ $user->image_path }}" >
                    </div>
                </div>
            </div>
            <!-- first_name end -->
