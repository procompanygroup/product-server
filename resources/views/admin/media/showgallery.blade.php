...
<div class="col-sm-2">
  <div  class="image-contain" >
    ...
    <input id="edit-{{$mediaproj->mediastore->id }}" class="btn btn-xs btn-primary update btn-modal" type="button" value="تعديل" data-toggle="modal" data-target="#modal-editimage">
    <input id="del-{{$mediaproj->mediastore->id }}" class="btn btn-xs btn-danger delete btn-modal" type="button" value="حذف" data-toggle="modal" data-target="#modal-delete">
