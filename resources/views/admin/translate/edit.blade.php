                        ...
                        id="create_form">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    placeholder="* الاسم" value="{{ $post->code }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 custom-control custom-switch ">
                                    ...
                                    value="1"  @if ($post->status == '1') @checked(true) @endif >
                              ...
                              <div class="card-body">
                                <div class="tab-content" id="trans-tabs-four-tabContent">
                                  ...
                                  <div class="tab-pane fade @once show active @endonce " id="lang-{{$lang->id}}" role="tabpanel" aria-labelledby="lang-{{$lang->id}}-tab">
                                    <form class="form-horizontal" name="update_trans_form-{{$lang->id}}" method="POST" action="{{route('langpost.update', $post->id)}}" 
