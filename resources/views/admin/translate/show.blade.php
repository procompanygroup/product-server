        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">الترجمة</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">الترجمة</h3>

          <div class="card-tools">
          <a class="btn btn-info btn-sm" href="{{url('admin/translate/create')}}">
                              <i class="fas fa-plus">
                              </i> جديد</a>
        ...
        <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                <tr>
                  ...
                  <td>    <a class="btn btn-info btn-sm" href="{{url('admin/translate/edit', $item->id)}}">
                              <i class="fas fa-pencil-alt">
                              </i>
                              تعديل
                          </a>
                          <form action="{{url('admin/translate/destroy', $item->id)}}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
