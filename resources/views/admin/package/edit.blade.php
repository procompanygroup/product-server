            ...
            <div class="card card-info">
                ...
                <div class="card-body  row">
                  <div class="col-lg-8">
                    ...
                    action="{{ url('admin/package/update',$item->id) }}" enctype="multipart/form-data" id="create_form">
                    @csrf
                    <!-- name start -->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="chat_count"class="form-control" id="chat_count"
                                placeholder="* عدد المحادثات" value="{{ $item->chat_count }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="search_count"class="form-control" id="search_count"
                                placeholder="* عدد عمليات البحث" value="{{ $item->search_count }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="favorite_count"class="form-control" id="favorite_count"
                                placeholder="* عدد الاشخاص " value="{{ $item->favorite_count }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 custom-control custom-switch ">
                            <input type="checkbox" class="custom-control-input" id="hidden_feature"
                                name="hidden_feature" value="{{ $item->hidden_feature }}"  @if ( $item->hidden_feature=='1') @checked(true) @endif >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 custom-control custom-switch ">
                            ...
                            value="{{ $item->show_img }}"  @if ( $item->show_img=='1') @checked(true) @endif  >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 custom-control custom-switch ">
                            <input type="checkbox" class="custom-control-input" id="special_member"
                                name="special_member" 
                                value="{{ $item->special_member }}"  @if ( $item->special_member=='1') @checked(true) @endif >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 custom-control custom-switch ">
                            ...
                            value="{{ $item->edit_name }}"  @if ( $item->edit_name=='1') @checked(true) @endif >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 custom-control custom-switch ">
                            ...
                            value="{{ $item->is_expire }}"  @if ( $item->is_expire=='1') @checked(true) @endif >
                            ...
                            <select class="form-control" name="expire_duration" id="expire_duration"
                                ...
                                $i=1;
                                 for($i==1;$i<=12;$i++) 
                                  {
                                    @endphp
                                    <option value="{{ $i }}" @if($item->expire_duration==$i) selected @endif >{{ $i }}</option> 
                                    @php
                                  }
                                  @endphp
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="price"class="form-control" id="price"
                                placeholder="* السعر " value="{{ $item->price }}">
