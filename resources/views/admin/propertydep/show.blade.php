    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm" href="{{url('admin/propdep/create')}}">
                              <i class="fas fa-plus">
                              </i> جديد</a>
        ...
        <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                <tr>
                  ...
                  <td>    <a class="btn btn-info btn-sm" href="{{route('propdep.edit', $item->id)}}">
                              <i class="fas fa-pencil-alt">
                              </i>
                              تعديل
                          </a>
                          <form action="{{url('admin/propdep', $item->id)}}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
