    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">الصفحات الثابتة </h3>

          <div class="card-tools">
          <a class="btn btn-info btn-sm" href="{{url('admin/page/create')}}">
                              <i class="fas fa-plus">
                              </i> جديد</a>
        ...
        <table id="example1" class="table table-bordered table-striped table-hover">
               ...
               @forelse ($pages as $page)
                <tr>
                  ...
                  <td>    <a class="btn btn-info btn-sm" href="{{url('admin/page/edit', $page->id)}}">
                              <i class="fas fa-pencil-alt">
                              </i>
                              تعديل
                          </a>
                          <form action="{{url('admin/page/delete', $page->id)}}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
                            <button type="button" id="del-{{$page->id}}" class="btn btn-danger btn-sm delete"  data-toggle="modal" data-target="#modal-delete"   title="حذف">   <i class="fas fa-trash">
                            </i>حذف</button>
</form>
                           </td>                
                </tr>
