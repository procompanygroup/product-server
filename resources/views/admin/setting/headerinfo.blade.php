            ...
            <div class="card card-info">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a class="btn btn-info btn-sm" href="{{ url('admin/setting/createhead') }}">
                            <i class="fas fa-plus">
                            </i> جديد</a>
                ...
                <div class="card-body  row">
                    <div class="col-lg-12">
                        ...
                        @endphp
                        @foreach ($List as $row)
                            <form action="{{ url('admin/setting/updatehead', [$row->id]) }}"
                                id="head-form-{{ ++$i }}" method="POST" enctype="multipart/form-data">
                                @csrf
