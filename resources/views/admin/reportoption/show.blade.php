                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">خيارات الابلاغ</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a class="btn btn-info btn-sm" href="{{ route('reportoption.create') }}">
                            <i class="fas fa-plus">
                            </i> جديد</a>
                        ...
                        <tbody>
                            ...
                            @forelse ($List as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->content }}</td>
                                    <td>@if($item->is_active==1)مفعل @else غير مفعل @endif</td>
                                    <td> <a class="btn btn-info btn-sm" href="{{ route('reportoption.edit', $item->id) }}">
                                            <i class="fas fa-pencil-alt">
                                            </i> تعديل </a>
                                        <form action="{{ route('reportoption.destroy', $item->id) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" id="del-{{ $item->id }}"
